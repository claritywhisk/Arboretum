/*
 * Modified  2024 Michael Stevenson
...
@Composable
fun ArboretumTabRow(
    onTabSelected: (ArboretumScreen) -> Unit,
    ...
    Surface(
        ...
        Row(Modifier.selectableGroup()) {
            ArboretumScreen.entries.forEach { screen ->
                ArbTab(
                    text = LocalContext.current.getString(screen.title),
